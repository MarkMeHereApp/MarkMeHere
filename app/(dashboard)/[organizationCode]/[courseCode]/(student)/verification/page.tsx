...
async function getCourse(attendanceTokenId: string) {
  try {
    ...
    if (!lectureId) {
      throw new Error(
        'This Attendance Token is Invalid, please scan or input the code again'
      );
    }
...
export default async function VerificationPage({
  ...
  return (
    <div className="relative h-screen">
      <VerifiactionPage code={attendanceTokenId} />
    </div>
  );
}
