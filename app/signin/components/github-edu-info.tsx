      ...
      <div className="pb-6">
        <Alert>
          ...
          <AlertDescription className="text-left">
            To log in with <b>{githubEduProvider.displayName}</b> you must
            ensure you have <b>one verified .edu</b> email linked to your GitHub
            account, it <b>doesn't have to be</b> your primary email, but it's
            the email we use to sign you in.
            <br />
            <br />
            <a
